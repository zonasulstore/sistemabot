  ...
  run: async (client, interaction, args) => {
    if (!interaction.member.permissions.has(Discord.PermissionFlagsBits.ManageGuild)) {
      ...
      let embed = new Discord.EmbedBuilder()
        .setAuthor({ name: `NOVO SORTEIO!`, iconURL: "https://cdn.discordapp.com/attachments/1033400992630321182/1035741428795588639/unknown.png" })
...
・Clique no botão para participar. **Boa sorte!!!**`)
